...
public class ActivityGenericIntentService extends IntentService implements SensorEventListener {
    ...
    public ActivityGenericIntentService() {
        super("ActivityGenericIntentService");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent bIntent = new Intent(ActivityGenericIntentService.this, TrainingActivity.class);
        PendingIntent pbIntent = PendingIntent.getActivity(ActivityGenericIntentService.this, 0, bIntent, 0);
